...
| `landau/fleche.py` | fleche digest hooks (`digest_hooks`), loaded only by fleche's entry-point machinery — landau never imports fleche (PR #441, refs #438). Hooks cover only types fleche rejects outright; closure-backed fits raise `Indigestible` |
