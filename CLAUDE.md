...
- Direct unit tests for `calc_phase_diagram::sub` (the tangent-endpoint `f_excess` reference from PR #231) landed in `tests/unit/test_calculate.py` (PR #258, closes #245) — extends the whole-pipeline coverage in `test_excess_endpoint_reference.py` with focused direct tests of the inner closure.
